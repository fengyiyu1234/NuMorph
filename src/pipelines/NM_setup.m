...
if ~isfile(atlas_path1) && ~isfile(atlas_path2)
    if ~exist(fullfile(home_path, 'data', 'atlas'), 'dir')
       mkdir( fullfile(home_path, 'data', 'atlas') );
    end
...
if ~isfile(flatview_path) && ~isfile(olf_cer_path) && ~isfile(ccfv3_path)
    if ~exist(fullfile(home_path, 'data', 'annotation_data'), 'dir')
      mkdir( fullfile(home_path, 'data', 'annotation_data') );
    end
